...
import { ThemeSamples } from "./theme-samples.component";
const styles = stylex.create({
  ...
  bookSwatch: { backgroundColor: material.book },
  ...
  return (
    <div {...stylex.props(styles.root)}>
      ...
      <section {...stylex.props(styles.section)}>
        <h2 {...stylex.props(styles.heading)}>One shared palette</h2>
        <div {...stylex.props(styles.grid)}>
          {[
            ...
            { name: "Neutral → text", value: "color.text", style: styles.text },
            {
              name: "Blue → accent",
              value: "color.accent",
              style: styles.accent,
      ...
      <section {...stylex.props(styles.section)}>
        ...
        <p {...stylex.props(styles.detail)}>
          ...
          stable control. Interactive objects have contrasting text on accent
          pill labels; phone labels stay visible without frames. The vinyl frame
          is circular. Books combine a group rotation with an independent volume

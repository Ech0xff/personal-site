...
const styles = stylex.create({
  cord: {
    ...
    height: {
      ...
      [media.deskCompact]: `calc(${shape.header} + 50px)`,
    },
  ...
  button: {
    position: "absolute",
    top: { default: "30px", [media.deskCompact]: "40px" },
    left: "50%",
  ...
  hint: {
    ...
    top: "50%",
    width: "max-content",
    maxWidth: "calc(50cqw - 76px)",
    paddingBlock: space.xs,
    paddingInline: space.sm,
    backgroundColor: "transparent",
    color: color.text,
    fontFamily: font.mono,
    fontSize: { default: font.small, [media.deskPhone]: font.tiny },
    lineHeight: 1.5,
    textAlign: "center",
    pointerEvents: "none",
    opacity: {

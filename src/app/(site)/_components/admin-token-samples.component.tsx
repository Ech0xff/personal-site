...
import { darkShadowTheme, darkTheme } from "#design/admin-theme.stylex";
import {
  color,
  font,
  media,
...
export function AdminTokenSamples() {
  return (
    <section aria-labelledby="admin-tokens" {...stylex.props(styles.section)}>
      <h2 id="admin-tokens" {...stylex.props(styles.heading)}>
        Shared interface tokens
      </h2>
      <p {...stylex.props(styles.intro)}>
        Forms, feedback, and code use the same semantic tokens. Dark overrides
        stay local to the sample and the administration interface.
      </p>

...
export function IntroductionSection({
  ...
  const statsItems = [
    {
      label: dictionary.indexHome.stats.posts,
      count: data.posts.count,
    },
    {
      label: dictionary.indexHome.stats.thoughts,
      count: data.thoughts.count,
    },
    {
      label: dictionary.indexHome.stats.events,
      count: data.events.count,
    },
    {
      label: dictionary.indexHome.stats.characters,
  ...
  return (
    ...
    >
      {/* About Card */}
      <Card title={dictionary.indexHome.about.cardTitle}>
      ...
      {hasPlaylist && (
        <Card title={dictionary.indexHome.playlist.cardTitle}>
          <iframe
            title={dictionary.indexHome.playlist.cardTitle}

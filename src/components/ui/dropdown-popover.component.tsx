  ...
  return (
    <Stack x className={cn("relative items-center", className)}>
      ...
      <Stack
        ...
        popover="auto"
        className={cn(
          "pointer-events-none fixed z-10 mt-2 flex -translate-x-1/2 scale-50 flex-col items-center rounded-md border border-(--border-default) bg-(--surface-card) px-2 py-1 text-(--text-secondary) opacity-0 shadow-sm transition-[opacity,scale] duration-200",

...
export const blocknoteStyles = stylex.create({
  ...
  root: {
    ...
    "--shiki-foreground": color.codeText,
    "--shiki-background": color.surfaceMuted,
    "--shiki-token-constant": color.codeNumber,
    "--shiki-token-string": color.codeString,
    "--shiki-token-comment": color.codeComment,
    "--shiki-token-keyword": color.codeKeyword,
    "--shiki-token-parameter": color.codeText,
    "--shiki-token-function": color.codeFunction,
    "--shiki-token-string-expression": color.codeString,
    "--shiki-token-punctuation": color.codeOperator,
    "--shiki-token-link": color.codeFunction,
    "--shiki-token-inserted": color.codeString,
    "--shiki-token-deleted": color.codeRegex,
